...
# Override with VERCEL_APP_URL if set (e.g. https://cyber-security-ruddy-psi.vercel.app)
APP_URL="${VERCEL_APP_URL:-https://cyber-security-ruddy-psi.vercel.app}"

add_env DATABASE_URL "$DB_URL"
# Use pooler for DIRECT_URL too when direct host is unreachable from Vercel
add_env DIRECT_URL "$DB_URL"
...
add_env ADMIN_SECRET 'qs-setup-355bcd6'
add_env CRON_SECRET 'qs-setup-355bcd6'
add_env ADMIN_EMAILS 'demo@quantumshield.io'
